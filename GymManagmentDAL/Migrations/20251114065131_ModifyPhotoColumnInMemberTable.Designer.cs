...
namespace GymManagmentDAL.Migrations
{
    ...
    [Migration("20251114065131_ModifyPhotoColumnInMemberTable")]
            ...
            modelBuilder.Entity("GymManagmentDAL.Entities.Member", b =>
                {
                    ...
                    b.ToTable("Members", t =>
                        {
                            t.HasCheckConstraint("GymUserEmailConstrain", "Email Like '_%@_%._%'");

                            t.HasCheckConstraint("GymUserPhoneConstrain", "Phone LIKE '01%' AND Phone NOT LIKE '%[^0-9]%'");
                        });
                });
            ...
            modelBuilder.Entity("GymManagmentDAL.Entities.Plan", b =>
                {
                    ...
                    b.ToTable("Plans", t =>
                        {
                            t.HasCheckConstraint("Plan_DurationDaysCheck", "DurationDays Between 1 and 365");
                        });
                });
            ...
            modelBuilder.Entity("GymManagmentDAL.Entities.Trainer", b =>
                {
                    ...
                    b.ToTable("Trainers", t =>
                        {
                            t.HasCheckConstraint("GymUserEmailConstrain", "Email Like '_%@_%._%'")
                                .HasName("GymUserEmailConstrain1");

                            t.HasCheckConstraint("GymUserPhoneConstrain", "Phone LIKE '01%' AND Phone NOT LIKE '%[^0-9]%'")
                                .HasName("GymUserPhoneConstrain1");
                        });
                });
