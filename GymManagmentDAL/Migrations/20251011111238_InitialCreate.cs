        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserEmailConstrain", "Email Like '_%@_%._%'");
                    table.CheckConstraint("GymUserPhoneConstrain", "Phone Like '01' and Phone Not Like '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Plan_DurationDaysCheck", "DurationDays Between 1 and 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserEmailConstrain1", "Email Like '_%@_%._%'");
                    table.CheckConstraint("GymUserPhoneConstrain1", "Phone Like '01' and Phone Not Like '%[^0-9]%'");
                });
